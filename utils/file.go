...
// GetMimeType detects MIMETYPE of a file
...
// IsImageMimeType checks if mimeType is image mimetype
func IsImageMimeType(mimeType string) bool {
	psdTypes := []string{"image/vnd.adobe.photoshop", "application/x-photoshop", "application/photoshop", "application/psd", "image/psd"}
	if Contains(psdTypes, mimeType) {
		return false
	}
	return model.MatchRegEx(`^image\/`, mimeType)
}

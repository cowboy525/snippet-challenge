...
require (
	...
	github.com/elastic/go-elasticsearch/v8 v8.0.0-20200918151311-dae5060a1a69 // indirect
	...
	github.com/topoface/onesignal-go v0.0.0-20210119163112-fa22cb52efd9 // indirect
